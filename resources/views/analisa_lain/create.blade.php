...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Tambah {{ ucfirst("analisa lain2") }}</li>
        </ol>
    </nav>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Tambah {{ ucfirst("analisa lain2") }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route("analisa_lain.store") }}" method="post">
                ...
                <p>
                    ...
                    <input type="number" step="any" class="form-control" name="bintik_hitam">
                </p>
                <p>
